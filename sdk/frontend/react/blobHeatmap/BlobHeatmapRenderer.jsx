/**
 * react/blobHeatmap/BlobHeatmapRenderer.jsx - 斑点热力（Canvas 2D）
 *
 ...
 * `core/blobHeatmap/intensity.js`，帧运算在 `core/blobHeatmap/pipeline.js`。
 *
 ...
 *    `core/blobHeatmap/pipeline.js` 与 `intensity.js` 的文件头。
...
import {
  colorize,
  createIntensity,
} from '../../core/blobHeatmap/intensity.js';
import { normalizeBlobHeatmapParams } from '../../core/blobHeatmap/params.js';
import {
  buildBlobPoints,
  frameStats,
  groupByAlpha,
} from '../../core/blobHeatmap/pipeline.js';
