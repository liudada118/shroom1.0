...
export function registerBuiltinRenderers() {
  const results = [
    ...
    registerRenderer({
      ...
      load: () => import('./webglHeatmap/WebglHeatmapRenderer.jsx'),
    ...
    registerRenderer({
      ...
      load: () => import('./blobHeatmap/BlobHeatmapRenderer.jsx'),
      capabilities: [RENDERER_CAPABILITIES.SIT],
      ...
      // 就只喂给一段死运算，见 `core/blobHeatmap/pipeline.js` 文件头。
      methods: [
        'sitData',
        'sitValue',
        'bthClickHandle',
