...
// Stream a release file into its metadata or transfer checksum.
...
// Validate the Windows release and return only the three files needed by the updater.
...
// Publish verified staged files under a lock, replacing the update metadata last.
...
// Stop publication immediately when a local OpenSSH command fails.
...
// Validate the current build, then upload it unless --dry-run was requested.
async function main() {
