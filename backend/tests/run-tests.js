...
const testFiles = [
  ...
  'backend/tests/agentApps/agentAppService.test.js',
  'backend/tests/agentApps/agentAppPackaging.test.js',
  'backend/tests/packaging/runtimeDependencies.test.js',
  ...
  'backend/tests/serial/serialManager.test.js',
  'backend/tests/serial/serialProtocolPresets.test.js',
  'backend/tests/serial/serialProtocolDetector.test.js',
  ...
  'backend/tests/http/agentAppsApi.test.js',
  'backend/tests/http/serialProtocolsApi.test.js',
  'backend/tests/http/serialProtocolDetectApi.test.js',
  'backend/tests/http/commandApi.test.js',
  'backend/tests/http/serialConnectionApi.test.js',
  ...
  'backend/tests/sdk/backendAgentAppsClient.test.js',
  ...
  'backend/tests/server/appRuntimeAgentApps.test.js',
  ...
  'backend/tests/server/pythonWorkerLifecycle.test.js',
  'backend/tests/server/applicationQuit.test.js',
