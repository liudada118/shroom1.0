...
> 本文档由 Manus 自动生成和维护。最后更新于：2026-03-23 05:32
...
| 2026-03-23 05:32 | Max | 优化重构 | Num2Doriginal.jsx 从纯 Canvas 2D 渲染改为 WebGL + Canvas overlay：WebGL 渲染颜色热力图（GPU 加速），Canvas 2D 叠加数字和网格线，robot 分区使用独立 WebGL + overlay canvas 对，RAF 节流渲染调度 |
| 2026-03-23 05:32 | Max | 修复缺陷 | 修复 robot1（宇树）原始数据模式左臂无数据：handL 索引从错误的 [126,125,124,123,142,141,140,139] 修正为 [80,79,96,95,112,111,128,127]，同步修正左肩/右肩索引映射 |
