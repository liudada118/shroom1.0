...
| 完成时间 | 分支 | 完成的功能/工作 | 说明 |
| :--- | :--- | :--- | :--- |
| 2026-08-13 | Codex | 人体悬停放大镜纯数据模型 | 新增无依赖的悬停工具模块，提供原始加权值、最近点查找、同部位同侧邻域和视口安全定位；Vitest 覆盖其公开契约。 |
...
| 时间 | 分支 | 变更类型 | 描述 |
| :--- | :--- | :--- | :--- |
| 2026-08-13 | Codex | 新增功能 | 新增 `humanBodyHoverData.js`，为人体悬停放大镜提供原始加权值、距离限界的最近点选择、隔离的邻域网格和视口钳制。 |
