...
import { Menu, Slider, Button, Select, message, Divider, Space, Radio, Drawer } from 'antd';
...
class Title extends React.Component {
  ...
  render() {
    const routerStr = this.props.matrixName == 'yanfeng10' ? '10a10' : this.props.matrixName == 'matCol' || this.props.matrixName == 'matColPos' ? '16a10' : this.props.matrixName == 'carCol' ? '10a9' : '32a32'
    ...
    return <div className="title">
      {/* <h2>bodyta</h2> */}
      <div style={{ display: 'flex', alignItems: 'center', color: '#5A5A89' }}> <img src={logo} style={{ height: '60px' }} alt="" />JQTOOLS-241128</div>
      <div className="titleItems">
        ...
        {this.props.matrixName != 'localCar' ? this.props.history === 'now' ? this.props.matrixName != 'car' && this.props.matrixName != 'car10' && this.props.matrixName != 'yanfeng10' && this.props.matrixName != 'volvo' ? <><Select
        ...
        >
          ...
          style={{ marginRight: 20, width: 160 }}
          placeholder={t('chooseSitSensor')}
          value={this.props.portname ? `${this.props.portname}(${t('sit')})` : null}
          onDropdownVisibleChange={() => {
            this.props.wsSendObj({ serialReset: true })
          }}
          onSelect={(e) => {
        ...
        >
          ...
          <Select
            ...
            style={{ marginRight: 20, width: 160 }}
            value={this.props.portnameBack ? `${this.props.portnameBack}(${t('back')})` : null}
          ...
          {this.props.matrixName == 'volvo' ? <Select
            // value={this.props.portnameBack}
        ...
        {!this.props.local ?
          <>
            ...
            <Button
              ...
              }}>{this.props.colFlag ? t('col') : t('stop')}{this.props.matrixName == 'localCar' ? this.props.length - 1 : this.state.num}
            </Button>
            {this.props.matrixName == 'localCar' ?
        ...
        {this.props.matrixName != 'car10' ? <Button
          ...
          }}>{this.props.numMatrixFlag == 'normal' ? t('matrix') : this.props.numMatrixFlag == 'num' ? '2D' : t('heatmap')}</Button> :
          <Button
            className='titleButton'
            onClick={() => {
      ...
      <div style={{ position: 'relative' }}>
        ...
        <Drawer style={{ backgroundColor: 'rgba(21,18,42,0.8)' }} title={t('setData')} onClose={() => { this.setState({ open: false }) }} open={this.state.open}>
          ...
          <>
            ...
            />
            {this.props.matrixName == 'volvo' ? <> <Button onClick={() => {
              // this.props.dataZero()
              // this.setState({
              //   resetZero: true
              // })
