        ...
        return (
            <div className='aside'>
               {this.props.matrixName != 'bed40' ? <div className="asideContent firstAside">
                    {this.props.matrixName != 'foot' ? <><h2 className="asideTitle">{t('sensorPanel.pressureArea')}</h2>
                ...
                <div className="asideContent firstAside">
                    <h2 className="asideTitle">{isSmallBed12B ? t('pressureIntensityData') : t('sensorPanel.pressureData')}</h2>
