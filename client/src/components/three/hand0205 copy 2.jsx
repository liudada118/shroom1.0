...
import uv from '../../assets/images/handuv.png'
...
const Canvas = React.forwardRef((props, refs) => {
  ...
  function init() {
    ...
    loader.load("./model/handh.glb", function (gltf) {
      chair = gltf.scene;
      // if (props.body) {
      ...
      const ctx1 = bodyCanvasRef.current.getContext('2d');
      ...
      addCanvas(chair, bodyCanvasRef.current)
      // chair.rotation.z = -Math.PI;
      // 初版
