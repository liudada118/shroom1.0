...
const Canvas = React.forwardRef((props, refs) => {
  ...
  function initSet() {
    ...
    particles.scale.x = 0.0011;
    particles.scale.y = 0.0011;
    particles.scale.z = 0.0011;
  ...
  function initndata1Data() {
    ...
    // let glovesPoints = [
    //   [20, 3], [20, 4], [26, 7], [26, 8], [27, 14], [27, 15], [24, 19], [24, 20], [9, 27], [9, 28],
    //   [18, 3], [18, 4], [22, 7], [22, 8], [23, 13], [23, 14], [20, 18], [20, 19], [8, 24], [8, 25],
    //   [15, 4], [15, 5], [18, 7], [18, 8], [19, 12], [19, 13], [17, 17], [17, 18], [7, 21], [7, 22],
    ...
    //   newZeroArr[(glovesPoints[i][0] + 3) * 32 + glovesPoints[i][1]] = 5
    // }
    ...
    for (let i = 3 * 10 + 2 * 8; i < 3 * 10 + 2 * 8 + 5 * 10; i++) {
      ...
      newZeroArr[glovesPoints[i][0] * 32 + glovesPoints[i][1] + 1] = 5
      newZeroArr[glovesPoints[i][0] * 32 + glovesPoints[i][1] - 1] = 5
      // newZeroArr[glovesPoints[i][0] * 32 + glovesPoints[i][1] + 3] = 5
  ...
  function sitRenew() {
    ...
    // const quaternion = transformQuaternion(rotate1)
    if (baseQuaternion) {
      if (group) group.quaternion.copy(quaternion);
    }

    // ndata1 = new Array(1024).fill(0)
    initndata1Data()
