...
const Canvas = React.forwardRef((props, refs) => {
  ...
  // const backConfig = { sitnum1: 16, sitnum2: 16, sitInterp: 4, sitInterp1: 2, sitOrder: 3 }
  const sitConfig = { sitnum1: 20, sitnum2: 14, sitInterp: 2, sitInterp1: 2, sitOrder: 3 }
  ...
  let allConfig = {
    ...
    //   name: 'back',
    //   pointConfig: { position: [xValue + 15, yValue - 8, -83 + zValue], rotation: [-Math.PI / 12, 0, 0], scale: [0.007, 0.007, 0.007] },
    // },
    sit: {
      dataConfig: sitConfig,
      name: 'sit',
      pointConfig: { position: [11, 200,  -141], rotation: [-Math.PI / 4, 0, 0], scale: [0.007, 0.007, 0.007] },
    },
    // handLeft: {
  ...
  function changaCamera(obj){
    console.log(obj)
    const light = pointGroup.children.find((a) => a.name == 'sit')
