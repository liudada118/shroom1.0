...
const neckConfig = { sitnum1: 3, sitnum2: 2, sitInterp: 4, sitInterp1: 2, sitOrder: 3, }
const backConfig = { sitnum1: 3, sitnum2: 2, sitInterp: 4, sitInterp1: 2, sitOrder: 3 }
const sitConfig = { sitnum1: 10, sitnum2: 6, sitInterp: 2, sitInterp1: 2, sitOrder: 3 }
...
const Canvas = React.forwardRef((props, refs) => {
  ...
  let allConfig = {
    neck: {
      ...
      name: 'neck',
      pointConfig: { position: [xValue, yValue, -11 + zValue], rotation: [] },
    },
    back: {
      dataConfig: backConfig,
      name: 'back',
      pointConfig: { position: [xValue + 10, yValue, -11 + zValue], rotation: [] },
    },
    sit: {
      dataConfig: sitConfig,
      name: 'sit',
      pointConfig: { position: [3 + 2.3, yValue, -12.2 + zValue], rotation: [] },
    },
    // handLeft: {
  ...
  function render() {
    ...
    const neck = ndata1.slice(0, 6)
    const back = ndata1.slice(6, 12)
    const sit = ndata1.slice(12, 12 + 6 * 10)
