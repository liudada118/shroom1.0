...
const Canvas = React.forwardRef((props, refs) => {
  ...
  const backConfig = { sitnum1: 16, sitnum2: 16, sitInterp: 4, sitInterp1: 4, sitOrder: 3 }
  const sitConfig = { sitnum1: 16, sitnum2: 16, sitInterp: 4, sitInterp1: 4, sitOrder: 3 }
  ...
  let allConfig = {
    ...
    //   name: 'neck',
    //   pointConfig: { position: [xValue - 2.5, yValue - 5.5, -103 + zValue], rotation: [0, 0, 0], scale: [0.006, 0.006, 0.006] },
    // },
    back: {
      dataConfig: backConfig,
      name: 'back',
      pointConfig: { position: [1 + 2.8 + 40, yValue + 20, -65 + zValue], rotation: [-Math.PI/6, 0, 0], scale: [0.007, 0.007, 0.007] },
    },
    sit: {
      dataConfig: sitConfig,
      name: 'sit',
      pointConfig: { position: [1 + 2.8 -20, yValue + 20, -65 + zValue], rotation: [-Math.PI/6, 0, 0], scale: [0.007, 0.007, 0.007] },
    },
    // handLeft: {
