...
export default function PortalWorkspaceTools({ open, onClose, rendererRef, selectionActive, onSelectionChange, items = [] }) {
  ...
  return <div className="portal-workspace-tools" data-native-view={Boolean(support.view)}><PortalUtilityPanel open={open} onClose={onClose} items={[
    ...viewItems,
    ...
    { id: 'ruler', category: 'analysis', label: '屏幕量尺', icon: <ColumnWidthOutlined />, active: ruler,
      description: '点击两个位置测量屏幕 px 距离；不是传感器毫米尺寸。量尺与框选互斥。',
    ...
    ...items,
  ]} /><PortalScreenRuler active={ruler} onClose={() => setRuler(false)} /></div>;
}
